const projectData = [
  {
    ...
    date: "January 2022",
    description:
      "A constantly maintained personal website that serves as a directory of my resume, personal projects, as well as other relevant documents. Previously this website used custom layout I created, using Jekyll as a templating engine. It is now written in React with a Node/Express backend.",
